...
void test_reverse_lists()
{
	...
	assert(reverse_result == SUCCESS && is_at_begining(list, 40) && is_before(list, 40, 30) && is_after(list, 10, 20) && is_at_end(list, 10));
